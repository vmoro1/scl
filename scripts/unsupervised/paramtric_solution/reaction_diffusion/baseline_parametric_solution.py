...
parser.add_argument('--nu_test', nargs='+', default=[1.0, 2, 4], help='nu for testing after training.')
parser.add_argument('--rho_test', nargs='+', default=[1.0, 2, 4], help='rho for testing after training.')
