...
parser.add_argument('--epochs', type=int, default=65000, help='Number of epochs to train for.')
...
parser.add_argument('--eps', nargs='+', default=[5e-1, 1e-3], help='Tolerances for the constraints.')
