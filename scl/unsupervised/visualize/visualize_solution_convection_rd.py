# Visualize the solutions for the convection and reaction-diffusion equations (the exact solution, the 
# difference between the exact and predicted solution, and the predicted solution).
...
def u_diff(Exact, U_pred, x, t, path, relative_error = False, suffix=""):
...
def u_predict(u_vals, U_pred, x, t, path, suffix=""):
