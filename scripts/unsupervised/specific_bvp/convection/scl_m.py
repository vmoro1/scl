# SCL(M) for the convection equaiton.
...
def main():
    ...
    solver = SimultaneousPrimalDual(constrained_pinn, optimizers, args.lr_primal, args.lr_dual, args.epochs, args.recompute, args.eval_every, X_test, u_exact)
