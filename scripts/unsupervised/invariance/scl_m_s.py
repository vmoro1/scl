...
parser.add_argument('--eps', nargs='+', default=[1e-3, 1e-2], help='Tolerances for the constraints.')
...
parser.add_argument('--causal', action=argparse.BooleanOptionalAction, default=False, help='Whether to start sampling from t=0 or from a random t. Starting from t=0 is similair to causal training of PINNs')
